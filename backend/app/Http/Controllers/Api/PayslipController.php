...
public function adminIndex(Request $request): JsonResponse
{
    ...
    $formatted = $payslips->map(function ($payslip) {
        return [
            ...
            'employment_type' => $payslip->employee->employment_type ?? 'N/A', // ADDED
    ...
    public function store(Request $request): JsonResponse
{
    ...
    // Create detailed breakdown for payslip (NOW INCLUDING PENSION)
    $breakdown = [
        ...
        'pension_deduction' => $payrollCalculation['deductions']['pension_deduction'], // ADDED PENSION
        ...
        'tax_config_used' => [
            ...
            'nhima_rate' => '1% of basic',
            'pension_rate' => '5% of basic (full-time only)', // ADDED
    ...
    Log::info('PayslipController: Creating new payslip', [
        ...
        'gross_salary' => $payrollCalculation['gross_salary'],
        'total_deductions' => $payrollCalculation['deductions']['total_deductions'],
        'pension_deduction' => $payrollCalculation['deductions']['pension_deduction'], // ADDED
        'net_pay' => $payrollCalculation['net_salary'],
    ]);
    
    // Create payslip record (NOW INCLUDING PENSION FIELD)
    $payslip = Payslip::create([
        ...
        'pension' => $payrollCalculation['deductions']['pension_deduction'], // ADDED PENSION
        'other_deductions' => 0,
        'total_deductions' => $payrollCalculation['deductions']['total_deductions'],
        'net_pay' => $payrollCalculation['net_salary'],
        'status' => 'generated',
    ...
    Log::info('PayslipController: Payslip created successfully', [
        ...
        'employee_id' => $employee->id,
        'pension_applied' => $payslip->pension > 0, // ADDED
    ]);
