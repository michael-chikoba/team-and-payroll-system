        ...
        <div class="sm:flex sm:items-start">
          <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
            ...
            <p class="mt-2 text-sm text-gray-500">
              Update the details of this cross-business task.
            </p>

            <form @submit.prevent="updateTask" class="mt-6 space-y-4">
              <!-- Title -->
              <div>
              ...
              <div class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                ...
                >
                  <span v-if="!submitting">Update Task</span>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const updateTask = async () => {
      ...
      try {
        const response = await axios.put(`/api/group-tasks/${props.task.id}`, form.value)
