        ...
        <div class="sm:flex sm:items-start">
          <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
            ...
            <p class="mt-2 text-sm text-gray-500">
              Create a task that can be assigned and managed across multiple businesses in your group.
            </p>
            ...
            <form @submit.prevent="createTask" class="mt-6 space-y-4">
              ...
              <div class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                ...
                >
                  <span v-if="!submitting">Create Task</span>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const createTask = async () => {
      ...
      try {
        const response = await axios.post('/api/group-tasks', form.value)
