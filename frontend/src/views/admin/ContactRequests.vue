        ...
        <div class="header-inner">
          ...
          <div class="user-greeting">
            <div class="avatar-section">
              ...
              <div class="user-info">
                <h1 class="greeting">Contact Requests</h1>
            ...
            <div class="header-controls">
              ...
              <button @click="loadContactRequests" class="btn-icon" title="Refresh Data" :disabled="loading">
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card" style="--accent:#10b981;">
          ...
          <div class="stat-info">
            ...
            <div class="stat-trend">Replied to</div>
          </div>
        </div>
              ...
              <tr v-for="request in paginatedRequests" :key="request.id">
                ...
                <td>
                  <div class="contact-cell">
                    <span class="contact-name">{{ request.name }}</span>
                    <span class="contact-email">{{ request.email }}</span>
                  </div>
                </td>
                <td>
                  <div class="subject-cell">
                    <span class="subject-title">{{ request.subject }}</span>
                    <span class="message-preview">{{ truncateMessage(request.message) }}</span>
                  </div>
                </td>
                <td>
                ...
                <td class="text-right">
                  <div class="action-buttons">
                    ...
                    <button @click="sendEmail(request)" class="btn-icon-small" title="Reply">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div v-if="selectedRequest" class="modal-overlay" @click.self="closeModal">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="detail-section">
            ...
            <div class="detail-grid">
              <div class="detail-item">
                ...
                <span class="detail-value">{{ selectedRequest.name }}</span>
              </div>
              <div class="detail-item">
          ...
          <div class="detail-section">
            ...
            <div class="detail-grid">
              ...
              <div v-if="selectedRequest.responded_at" class="detail-item">
                <span class="detail-label">Responded On:</span>
                <span class="detail-value">{{ formatDateTime(selectedRequest.responded_at) }}</span>
              </div>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          ...
          <button @click="sendEmail(selectedRequest)" class="btn-accent">Reply</button>
        </div>
      </div>
    </div>
