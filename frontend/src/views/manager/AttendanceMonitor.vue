...
export default {
  ...
  methods: {
    ...
    async fetchAttendance(retry = false) {
      ...
      try {
        console.log('📡 Fetching attendance for date:', this.selectedDate);
        ...
        console.log('📊 Calculated Overview:', {
          totalEmployees,
          presentOnTime,
          late,
          absent,
    ...
    viewHistory(employee) {
      this.showAlert(`Attendance history for ${employee.full_name} would open in a real app.`);
    },
